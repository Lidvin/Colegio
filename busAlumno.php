...
<html lang="es">
  ...
  <div class="container">
  <h1 class="text-center">::: BUSQUEDA ALUMNO :::</h1>
          ...
          <div class="input-group col-lg-4 col-sm-4">
              <span class="input-group-addon" id="sizing-addon2">Fecha inscripción-alumno: </span>
                <input name="fec1" type="text" class="form-control" value="<?php echo $row['FEC'];?>" disabled>
          </div>
          ...
          <div class="input-group col-lg-6 col-sm-6">
            ...
            <input name="nom11" type="text" class="form-control" placeholder="Juan" value="<?php echo $row['NALUM'];?>" disabled>
          </div>
          ...
          <div class="input-group col-lg-2 col-sm-2">
            ...
            <input name="iden1" type="text" class="form-control" placeholder="C987PAQ" value="<?php echo $_GET['ida'];?>" disabled>
          </div>
          ...
          <div class="input-group col-lg-2 col-sm-2">
            ...
            <input name="fol1" type="text" class="form-control" placeholder="A123" value="<?php echo $row['FOL'];?>" disabled>
          </div>
          <div class="input-group col-lg-2 col-sm-2">
            <span class="input-group-addon" id="sizing-addon2">Libro </span>
            <input name="lib1" type="text" class="form-control" placeholder="911" value="<?php echo $row['LIB'];?>" disabled>
          </div>
          <div class="input-group col-lg-2 col-sm-2">
            <span class="input-group-addon" id="sizing-addon2">Acta </span>
            <input name="act1" type="text" class="form-control" placeholder="123" value="<?php echo $row['ACT'];?>" disabled>
          </div>
          <div class="input-group col-lg-6 col-sm-6">
            <span class="input-group-addon" id="sizing-addon2">Dirección </span>
            <input name="dir1" type="text" class="form-control" placeholder="Caserío Villa Nueva, Malacatán, S.M." value="<?php echo $row['DIR'];?>" disabled>
          </div>
          ...
          <div class="btn-group input-group col-lg-2 col-sm-2">
            ...
            <select name="sex1" class="form-control" disabled>
              <?php if ($row['SEX']=='M') { ?>
          ...
          <div class="btn-group input-group col-lg-3 col-sm-3">
            ...
            <select name="est1" class="form-control" disabled>
            <?php if ($row['BEC']=='0') { ?>
          ...
          <div class="btn-group input-group input-group col-lg-4 col-sm-4">
            ...
            <input name="enc1" type="text" class="form-control" placeholder="Pérez Alvarado José Daniel" value="<?php echo $row['ENC'];?>" disabled>
          </div>

          <div class="btn-group input-group input-group col-lg-3 col-sm-3">
            <span class="input-group-addon" id="sizing-addon2">DPI </span>
            <input name="dpi1" type="text" class="form-control" placeholder="2742439151208" value="<?php echo $row['DPI'];?>" disabled>
          </div>
          ...
          <div class="btn-group input-group col-lg-4 col-sm-4">
            ...
            <select name="dep1" class="form-control" disabled>
          ...
          <div class="btn-group input-group col-lg-4 col-sm-4">
            ...
            <input type="text" class="form-control" value="<?php echo $row['NIV'];?>" disabled>
          </div>

          <div class="btn-group input-group col-lg-4 col-sm-4">
            <span class='input-group-addon' id='sizing-addon2'>Profesor </span>
            <input type="text" class="form-control" value="<?php echo $row['NON'];?>" disabled>
          </div>

          <br><br><br>
          <div align="center" class="container">
            <a href="alumno.php"><input class="btn btn-primary" type="submit" value="Regresar"></a>
          </div>
  </div>
