...
<html lang="es">
  ...
  <body>
    ...
    <div class="container">
    <div class="col-lg-6 col-sm-6 address wow fadeInUp">
      <div class="panel panel-primary">
  <div class="panel-heading">
    <h2 class="panel-title address wow fadeInUp">Información del usuario</h2>
  </div>
      <p class="alert alert-info address wow fadeInUp ">Nombre: <br>
...
<div class="container">
    <div class="col-lg-12 col-sm-12 address wow fadeInUp">
      <div class="panel panel-primary">
  <div class="panel-heading" align="center">
    <h2 class="panel-title address wow fadeInUp">CRUD DE DATOS</h2>
  </div>
  <div class="panel-footer address wow fadeInUp">
  <br><br>
      <div class="col-lg-2 col-sm-2"></div>
      <div class="col-lg-2 col-sm-2"><a href="alumno.php"><button type="button" class="btn btn-primary btn-group btn-group-justified">Alumno</button></a></div>
      <div class="col-lg-1 col-sm-1"></div>
      <div class="col-lg-2 col-sm-2"><a href="profesor.php"><button type="button" class="btn btn-primary btn-group btn-group-justified">Profesor</button></a></div>
      <div class="col-lg-1 col-sm-1"></div>
      <div class="col-lg-2 col-sm-2"><a href="alumno.php"><button type="button" class="btn btn-primary btn-group btn-group-justified">Notas</button></a></div>
      <div class="col-lg-2 col-sm-2"></div>
      <br><br><br><br>
    </div>
  </div>
